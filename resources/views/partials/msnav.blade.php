 ...
 <nav class="bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-white">
     <div class="max-w-7xl mx-auto px-4 py-2 flex justify-between items-center">
         <div class="flex items-center space-x-3">
             <img src="img/logo/ms_logo.png" alt="Logo" class="h-12 w-auto" />
             <span class="text-lg md:text-xl font-bold leading-tight">श्री अखिल भारतवर्षीय साधुमार्गी जैन संघ-महिला समिति</span>
         </div>
         ...
         <div class="hidden md:flex items-center space-x-6 text-[15px] font-medium">
             ...
             <div class="flex items-center space-x-2 pl-4 border-l border-white">
                 ...
                 <span class="text-sm font-semibold whitespace-nowrap">
                     Helpline (WhatsApp): <a href="https://wa.me/916375633109" target="_blank" class="underline hover:text-yellow-300">+91-63756 33109</a>
                 </span>
             </div>
         </div>
     ...
     <div class="max-w-7xl mx-auto px-4 py-2 flex justify-center items-center">
         ...
         <div class="hidden md:flex space-x-6 text-gray-800 text-[15px] font-medium">
             ...
             <div class="relative z-50 group">
                 ...
                 <a href="\mahila" class="hover:text-orange-500">परिचय </a>
             ...
             <a href="/pics-ms" class="hover:text-orange-500">फोटो गैलरी</a>
              <a href="/activities-ms" class="hover:text-orange-500">प्रवृत्तियाँ</a>
...
<div id="mobile-nav" class="md:hidden hidden px-4 pb-4 space-y-2 text-[15px] text-gray-800 font-medium">
    ...
    <a href="/mahila" class="block hover:text-orange-500">परिचय</a>
    <a href="/pics-ms" class="block hover:text-orange-500">फोटो गैलरी</a>
    <a href="/activities-ms" class="block hover:text-orange-500">प्रवृत्तियाँ</a>
